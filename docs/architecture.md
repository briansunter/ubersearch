...
- **Dependency injection**: `src/bootstrap/container.ts` wires config, credit state provider, credit manager, provider registry, strategy factory, and orchestrator into an isolated container per bootstrap call.
